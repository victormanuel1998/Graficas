...
<figure class="highcharts-figure">
  ...
  <p class="highcharts-description">
    Gráfica donde muestra el número total de integrantes y la corde que se agrupan
  </p>
        <table id="datatable">
    ...
    Highcharts.chart('container', {
      ...
      title: {
        text: 'Grafica por el total de numero de integrantes por sexo por el corde '
      },
      subtitle: {
